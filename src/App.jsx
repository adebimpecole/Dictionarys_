            ...
            <div className="dictionary_start">
                            ...
                            <ul className="meaning">
                              {meaning.definitions ? (
                                meaning.definitions.map((mn, defIndex) => (
                                  <li key={defIndex} className="mean">
                                    {mn.definition}
                                  </li>
                                ))
                              ) : (
                            ...
                            <ul className="list">
                              {meaning.synonyms ? (
                                meaning.synonyms.map((syn, synIndex) => (
                                  <li key={synIndex} className="mean">
                                    {syn}
                                  </li>
                                ))
                              ) : (
                            ...
                            <ul className="list">
                              {meaning.antonyms ? (
                                meaning.antonyms.map((ant, antIndex) => (
                                  <li key={antIndex} className="mean">
                                    {ant}
                                  </li>
                                ))
                              ) : (
              ...
              <div className="source">
                ...
                <div>
                  Source:
                  {data[0].license.url ? (
                    <a href={data[0].license.url} className="url" id="mylink">
                      {data[0].license.url}
                    </a>
                  ) : (
                    <span></span>
              ...
              {adio && adio[0] ? (
                <>
                  ...
                  <div className="second_part">
                    <div className="word_dets">
                      <span className="noun">
                        {adio[0].meanings[0].partOfSpeech}
                      </span>
                      <hr />
                    </div>
                    <div className="meaning_div">
                      ...
                      <ul className="meaning">
                        <li className="mean">
                          {adio[0].meanings[0].definitions[0].definition}
                        </li>
                      </ul>
                    </div>
                  </div>
